...
def preprocess_opts(parser):
    ...
    group.add_argument('-src_vocab', default="",
                       ...
                       one word per line.""")
    group.add_argument('-template_vocab', default="",
                       help="""Path to an existing source vocabulary. Format:
                          one word per line.""")
    ...
    group.add_argument('-share_vocab', default=True,
...
def train_opts(parser):
    ...
    group.add_argument('-device_id', default=2, nargs='+', type=int,
                       help="Rank the current gpu device.")
...
def translate_opts(parser):
    ...
    group.add_argument('-template', required=True,
                       help="""template sequence to decode (one line per
                          sequence)""")
    group.add_argument('-src_dir', default="",
                       help='Source directory for image or audio files')
